...
s_woa09=s;
ptmp_woa09=ptmp;
ptmp_woa09(ptmp_woa09==0)=NaN;s_woa09(s_woa09==0)=NaN;
...
%fclose(fid);
lon2d=lon_woa09*ones(1,ny_b);
lat2d=ones(nx_b,1)*lat_woa09';
...
%mask_3d_woa09=reshape(reshape(mm,[],1)*ones(1,nz_b),nx_b,ny_b,nz_b);
...
mask_3d_woa09=reshape(reshape(mm,[],1)*ones(1,nz_b),nx_b,ny_b,nz_b);
mask_3d_woa09(find(isnan(t_woa09)|mask_3d_woa09~=1))=0;
