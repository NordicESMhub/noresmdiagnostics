...
% Interpolate WOA13 data to the destination grid
...
mask_3d_woa13(find(isnan(s_woa13_dst)|mask_3d_woa13~=1))=0;
...
%eval(['print -dpng ' picpath 'temp_zonalmean_indopac_' exp '_' num2str(year1) '-' num2str(year2) '_obs_diff.png'])
...
%Save plots
%eval(['print -dpng ' picpath 'saln_zonalmean_indopac_' exp '_' num2str(year1) '-' num2str(year2) '_obs_diff.png'])
...
title([' Indo-Pacific Zonal Mean Density Differences with WOA13, ' str_name_disp(exp) ', '  num2str(year1) '-'  ...
 ...
 % Save plot
 %eval(['print -dpng ' picpath 'den_zonalmean_indopac_' exp '_' num2str(year1) '-' num2str(year2) '_obs_diff.png'])
