...
% Control case name; Should be on the same grid as the Snesitivity case
...
% Path & name of the input model annual average file for the Sensitivity case
...
% Path & name of the input model annual average file for the Control case
...
ncid=netcdf.open(cntrlname,'NC_NOWRITE');
         nx=ncgetdim(cntrlname,'x');
         ny=ncgetdim(cntrlname,'y');
         nz=ncgetdim(cntrlname,'depth');
         depth=ncgetvar(cntrlname,'depth');
...
%eval(['print -dpng ' picpath 'temp_zonalmean_Indo-Pacific_' exp '_' num2str(year1) '-' num2str(year2) '_cntrl_diff.png'])

clear fld ;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Plot Indo-Pacific Mean Zonal SALINITY Model Sensitivity-Control case Difference (Figure(2))
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Save plots
%eval(['print -dpng ' picpath 'saln_zonalmean_Indo-Pacific_' exp '_' num2str(year1) '-' num2str(year2) '_cntrl_diff.png'])
...
title([' Indo-Pacific Zonal Mean Density Differences with Control, ' str_name_disp(exp) ', '  num2str(year1) '-'  ...
 ...
 % Save plot
 %eval(['print -dpng ' picpath 'den_zonalmean_Indo-Pacific_' exp '_' num2str(year1) '-' num2str(year2) '_cntrl_diff.png'])
