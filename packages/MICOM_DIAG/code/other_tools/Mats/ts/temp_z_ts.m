...
%               'monthly_diagnostics',0,...
%               'grid_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx1v1/20120120/grid.nc', ...
%               'path','/fimm/work/matsbn/hexagon-work/cgu025/archive/NBF1850_f19_tn11_Xmas/ocn/hist');
%%              'path','/fimm/work/matsbn/hexagon-work/cgu025/noresm/NBF1850_f19_tn11_Xmas/run');
...
%               'monthly_diagnostics',0,...
%               'grid_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx1v1/20120120/grid.nc', ...
%               'path','/fimm/work/matsbn/hexagon-work/cgu025/archive/NBF1850_f19_tn11_Xmas_enecon/ocn/hist');
%%              'path','/fimm/work/matsbn/hexagon-work/cgu025/noresm/NBF1850_f19_tn11_Xmas_enecon/run');
...
%               'monthly_diagnostics',0,...
%               'grid_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx1v1/20120120/grid.nc', ...
%               'path','/fimm/work/matsbn/hexagon-work/cgu025/archive/NBF1850_f19_tn11_Xmas_SolarAngle/ocn/hist');
%%              'path','/fimm/work/matsbn/hexagon-work/cgu025/noresm/NBF1850_f19_tn11_Xmas_SolarAngle/run');
...
%               'monthly_diagnostics',0,...
%               'grid_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx1v1/20120120/grid.nc', ...
%               'path','/fimm/work/matsbn/hexagon-work/cgu025/archive/NBF1850_f19_tn11_Xmas_SolarAngle_enecon/ocn/hist');
%%              'path','/fimm/work/matsbn/hexagon-work/cgu025/noresm/NBF1850_f19_tn11_Xmas_SolarAngle_enecon/run');
...
%expr(1)=struct('name','ATM_f09_MICOM_tnx025_MLD', ...
%               'name_disp','ATM_f09_MICOM_tnx025_MLD', ...
%               'first_year',1, ...
%               'last_year',50, ...
%               'display_first_year',1, ...
%               'add_to_expr',[], ...
...
%               'monthly_diagnostics',1,...
%               'grid_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx0.25v1/20130930/grid.nc', ...
%               'path','/fimm/work/matsbn/norstore-NS2345K/noresm/cases/ATM_f09_MICOM_tnx025_MLD/ocn/hist');
...
%expr(1)=struct('name','N1850_f19_tn11_jrlv1_02', ...
%               'name_disp','N1850\_f19\_tn11\_jrlv1\_02', ...
%               'first_year',1, ...
%               'last_year',50, ...
%               'display_first_year',1, ...
%               'add_to_expr',[], ...
...
%               'grid_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx1v1/20120120/grid.nc', ...
%               'monthly_diagnostics',1,...
%               'path','/fimm/work/matsbn/vilje-work/matsbn/archive/N1850_f19_tn11_jrlv1_02/ocn/hist');
%%              'path','/fimm/work/matsbn/vilje-work/matsbn/noresm/N1850_f19_tn11_jrlv1_02/run');
%expr(1)=struct('name','N1850_f19_tn11_jrlv3_02', ...
%               'name_disp','N1850\_f19\_tn11\_jrlv3\_02', ...
%               'first_year',1, ...
%               'last_year',50, ...
%               'display_first_year',1, ...
%               'add_to_expr',[], ...
...
%               'grid_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx1v1/20120120/grid.nc', ...
%               'monthly_diagnostics',1,...
%               'path','/fimm/work/matsbn/vilje-work/matsbn/archive/N1850_f19_tn11_jrlv3_02/ocn/hist');
%%               'path','/fimm/work/matsbn/vilje-work/matsbn/noresm/N1850_f19_tn11_jrlv3_02/run');
expr(1)=struct('name','N1850_f19_tn11_chl_02', ...
               'name_disp','N1850\_f19\_tn11\_chl\_02', ...
               'first_year',1, ...
               'last_year',50, ...
               'display_first_year',1, ...
               'add_to_expr',[], ...
               ...
               'grid_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx1v1/20120120/grid.nc', ...
               'monthly_diagnostics',1,...
               'path','/fimm/work/matsbn/vilje-work/matsbn/archive/N1850_f19_tn11_chl_02/ocn/hist');
%              'path','/fimm/work/matsbn/vilje-work/matsbn/noresm/N1850_f19_tn11_chl_02/run');
...
for nexp=1:length(expr)
  ...
  if exist(['temp_z_ts_' expr(nexp).name '.mat'])
    load(['temp_z_ts_' expr(nexp).name '.mat'])
  else
    year_list=[];
    temp_z=[];
  end
...
%%%
                ...
                temp_z_tmp(:,month)=nansum(reshape(temp3d,[],nz).*area_z)./area_z_sum;
...
%%%
            ...
            temp_z_tmp=(nansum(reshape(temp3d,[],nz).*area_z)./area_z_sum)';

            temp_z_tmp=temp_z_tmp*ones(1,12);
    ...
    if years_added
      ...
      temp_z=reshape(temp_z(smind),nz,[]);
      save(['temp_z_ts_' expr(nexp).name '.mat'], ...
           'year_list','temp_z','depth')
    end

  end

  expr(nexp).year_list=year_list;
  expr(nexp).temp_z=temp_z;
  expr(nexp).depth=depth;
  expr(nexp).temp_z_first_year=[];
...
for nexp=1:length(expr)
  ...
  if ~isempty(nexpa) && ~isempty(expr(nexpa).year_list)
    ...
    temp_z=expr(nexpa).temp_z;
    year_list=[year_list expr(nexp).year_list];
    temp_z=[temp_z expr(nexp).temp_z];
    [year_list svind]=sort(year_list);
    nz=size(temp_z,1);
    smind=(ones(nz*12,1)*(svind-1)*nz*12)+(1:nz*12)'*ones(1,length(svind));
    temp_z=reshape(temp_z(smind),nz,[]);
    expr(nexpa).year_list=year_list;
    expr(nexpa).temp_z=temp_z;
...
%   temp_z_yr=mon2ann(temp_z')';
    temp_z_yr=reshape(mw*reshape(temp_z',12,[]),[],size(temp_z,1))';

    iyf=find(year_list>=expr(nexp).first_year,1);
    iyl=find(year_list<=expr(nexp).last_year,1,'last');
    year_list=year_list(iyf:iyl);
      temp_z_yr=temp_z_yr(:,iyf:iyl);
    expr(nexp).temp_z_first_year=temp_z_yr(:,1);
    year_discont=[diff(year_list)~=1 1];
    iyl=0;
    if     expr(nexp).ref_exp==0
      temp_z_ref=interp1(depth_woa09,pt_z_woa09,depth);
    elseif expr(nexp).ref_exp==-1
      temp_z_ref=interp1(depth_phc30,pt_z_phc30,depth);
    else
      if isempty(expr(expr(nexp).ref_exp).temp_z_first_year)|| ...
         length(expr(expr(nexp).ref_exp).depth)~=length(depth)
        error(['The reference experiment for ' expr(nexp).name  ...
               ' is not appropriate!'])
      end
      temp_z_ref=expr(expr(nexp).ref_exp).temp_z_first_year;
    end
    while iyl<length(year_list)
      ...
      if plot_depth_mapped
        pcolor(time,depth_mapped, ...
               temp_z_yr(:,iyf:iyl)-temp_z_ref*ones(1,iyl-iyf+1));
      else
        pcolor(time,depth, ...
               temp_z_yr(:,iyf:iyl)-temp_z_ref*ones(1,iyl-iyf+1));
      end
...
title([expr(1).name_disp ' - Global mean temperature difference'], ...
      'FontSize',fontsize) 
h=colorbar;
ylabel(h,'K')
...
for nexp=length(expr):-1:1
  if expr(nexp).print
    ...
    print (gcf,'-dpng', '-r300', [picpath '/' expr(nexp).name '/temp_z_ts.png'])
    break
  end
end
