...
# HAMMOC DIAGNOSTICS package: regional_mean_obs.sh (not used in the diagnostics)
...
datadir=/projects/NS2345K/noresm_diagnostics_dev/packages/HAMMOC_DIAG/obs_data/WOA13
infile=$datadir/woa13_all_pMON_01

for region in ARC NATL NPAC TATL TPAC IND MSO HSO
do
    maskfile=/projects/NS2345K/noresm_diagnostics_dev/packages/HAMMOC_DIAG/grid_files/region_mask_1x1_${region}
