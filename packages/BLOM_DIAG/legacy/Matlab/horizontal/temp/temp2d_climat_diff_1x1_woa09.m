...
ncid=netcdf.open(t_woa09_file,'NC_NOWRITE');
         nx_b=ncgetdim(t_woa09_file,'lon');
         ny_b=ncgetdim(t_woa09_file,'lat');
         nz_b=ncgetdim(t_woa09_file,'depth');
         lon_b=ncgetvar(t_woa09_file,'lon');
         lat_b=ncgetvar(t_woa09_file,'lat');
         depth_a=ncgetvar(t_woa09_file,'depth');
