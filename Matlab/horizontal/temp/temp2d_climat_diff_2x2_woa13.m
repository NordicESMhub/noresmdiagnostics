...
ncid=netcdf.open(t_woa13_file,'NC_NOWRITE');
         nx_a_woa13=ncgetdim(t_woa13_file,'lon');
         ny_a_woa13=ncgetdim(t_woa13_file,'lat');
         nz_a_woa13=ncgetdim(t_woa13_file,'depth');
         lon_a_woa13=ncgetvar(t_woa13_file,'lon');
         lat_a_woa13=ncgetvar(t_woa13_file,'lat');
         depth_a_woa13=ncgetvar(t_woa13_file,'depth');
...
% Read regrid indexes and weights
  ...
  sst_woa13_b=reshape(S*t_src_woa13,nx_b,ny_b)./destarea;
...
sst_woa13_b=[sst_woa13_b((nx_b/2+1):end,:);sst_woa13_b(1:nx_b/2,:)];
