...
% 03/03/2015
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Regrids model and WOA09 obs horizontal Salinity fields on chosen depths (vertical levels)
...
ncid=netcdf.open(s_woa09_file,'NC_NOWRITE');
         nx_a_woa09=ncgetdim(s_woa09_file,'lon');
         ny_a_woa09=ncgetdim(s_woa09_file,'lat');
         nz_a_woa09=ncgetdim(s_woa09_file,'depth');
         lon_a_woa09=ncgetvar(s_woa09_file,'lon');
         lat_a_woa09=ncgetvar(s_woa09_file,'lat');
         depth_a_woa09=ncgetvar(s_woa09_file,'depth');
...
% Read regrid indexes and weights
  ...
  sss_woa09_b=reshape(S*t_src_woa09,nx_b,ny_b)./destarea;
...
% Shifting the grid to center at 0W [180W 180E]; Original 2x2 LatLon grid is [0 360]
