...
% Regrids the model fields to WOA13 0.25x0.25deg LatLon grid
...
%map_file='/work-common/shared/bjerknes/diagnostics/Packages/MICOM_DIAG/map_files/map_noresm_tnx0.25v1_to_woa09_0_25deg_aave_.nc';

% Grid file for WOA13 data
% Grunch & Hexagon
grid_woa13_file='/work-common/shared/bjerknes/diagnostics/Packages/MICOM_DIAG/grid_files/woa13/remap_grid_woa13p25_20150303.nc';
...
% Read  woa13 grid data
lat=ncread(grid_woa13_file,'grid_center_lat');
lon=ncread(grid_woa13_file,'grid_center_lon');
depth=ncread(t_woa13_file,'depth');
dims=ncread(grid_woa13_file,'grid_dims');
...
depth_woa13=depth;
%Shift
lon=[(lon((nx_b/2+1):end));lon(1:nx_b/2)+360];
